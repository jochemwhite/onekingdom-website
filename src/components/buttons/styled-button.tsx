...
export default function StyledButton({ href, innerText, openNewTab, icon }: BasicButtonProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        "flex items-center transition justify-between w-fit max-w-full no-underline text-base uppercase border-accent border-2 rounded-md leading-[46px] px-5 relative text-center tracking-wide *:mx-2",
        {
          "border-highlight text-primary  hover:text-white": isHover,
        }
      )}
