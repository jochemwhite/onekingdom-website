            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  {/* <FormLabel>Title</FormLabel> */}
                  <FormControl>
                    <Input id="email" placeholder="Discord Username" type="email" disabled={isLoading} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  {/* <FormLabel>Title</FormLabel> */}
                  <FormControl>
                    <Input id="email" placeholder="Twitch name" type="email" disabled={isLoading} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
