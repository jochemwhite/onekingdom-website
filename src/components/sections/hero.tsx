...
export default function Hero() {
  return (
    <div className="neoh_fn_hero h-screen bg-slate-600 flex justify-center items-center font-assassin">
      <div className="flex flex-col items-center z-30">
        <h4 className="text-7xl">Welcome To</h4>
        <h1 className="text-9xl">One Kingdom</h1>
      </div>
