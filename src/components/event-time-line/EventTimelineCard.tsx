...
export default function EventTimelineCard({ event }: Props) {
  return (
    <div className="w-full h-[800px] lg:h-[500px] list-none " style={{ margin: "1rem 0" }}>
      <div className="p-[40px] w-full h-full border-accent hover:border-highlight border-2  rounded-md flex flex-col items-stretch lg:flex-row transition-all duration-300 ease">
