...
const editorVariants = cva(
  cn(
    ...
    'min-h-[80px] w-full rounded-md bg-white  py-2 text-sm ring-offset-white placeholder:text-slate-500 focus-visible:outline-none dark:bg-slate-950 dark:ring-offset-slate-950 dark:placeholder:text-slate-400',
