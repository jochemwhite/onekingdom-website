...
export default async function Home() {
  const onekingdomStreamers = members.filter((member) => member.onekingdomStreamer).sort((a, b) => a.name.localeCompare(b.name));
  const staff = members.filter((member) => member.staff).sort((a, b) => a.name.localeCompare(b.name));
